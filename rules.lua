...
return function(ttd_util)
      ...
      -- default rules text... -------------------------------------------------
      local default_rules = [[<center>┏━━━━━━━━━━━━━━━━━━━━━━━━━━━┓</center>
...
rules...
      ...
      -- Layout constants ---------------------------------------------------
      local pad, form_w, form_h, button_h = 0.325, 9, 11, 0.85
      ...
      local function get_rules_formspec(player)
            local accepted =
                  player:get_meta():get_string("ttd_util_accepted_rules") == "true"
            ...
            if accepted then
                  ...
                  fs[#fs + 1] =
                        "button_exit[" .. close_x .. "," .. button_y .. ";" ..
                        button_w .. "," .. button_h ..
                        ";ttd_util_rules_close;Close]"
            else
                  fs[#fs + 1] =
                        "style[ttd_util_rules_disagree;bgcolor=red]"
                  fs[#fs + 1] =
                        "button[" .. pad .. "," .. button_y .. ";" ..
                        button_w .. "," .. button_h ..
                        ";ttd_util_rules_disagree;I do not agree!]"
                  fs[#fs + 1] =
                        "style[ttd_util_rules_agree;bgcolor=green]"
                  fs[#fs + 1] =
                        "button[" .. (pad * 2 + button_w) .. "," .. button_y ..
                        ";" .. button_w .. "," .. button_h ..
      ...
      local function get_setrules_formspec(current_text)
            ...
            local fs = {
                  ...
                  "no_prepend[]",
                  "bgcolor[#00000000]",
                  "background9[0,0;" .. width .. "," .. form_h ..
                        ";gui_formbg.png;true;10]",

                  "container[" .. pad .. "," .. (button_h + pad * 2) .. "]",
                  "textarea[0,0;" .. content_w .. "," .. content_h ..
                        ";ttd_util_edit_rules_input;;" ..
                        core.formspec_escape(current_text) .. "]",

                  "box[" .. (content_w + pad) .. ",0;" ..
                        content_w .. "," .. content_h .. ";#000000]",
                  "container[" .. (content_w + pad + txt_area_pad) ..
                        "," .. txt_area_pad .. "]",
                  "hypertext[0,0;" ..
                  ...
                  "image_button[" ..
                        (width - pad - button_w - pad - button_h) .. "," ..
                        pad .. ";" .. button_h .. "," .. button_h ..
                        ";refresh.png;refresh_rules;]",
                  "style[save_rules;bgcolor=green]",
                  "button[" .. (width - pad - button_w) .. "," .. pad ..
                        ";" .. button_w .. "," .. button_h ..
                        ";save_rules;Save]",
                  "button[" .. pad .. "," .. pad .. ";" ..
                        button_w .. "," .. button_h ..
      ...
      core.register_on_player_receive_fields(function(player, formname, fields)
            ...
            if formname == "ttd_util_rules:set" then
                  ...
                  if fields.save_rules and fields.ttd_util_edit_rules_input then
                        set_rules_text(fields.ttd_util_edit_rules_input)
